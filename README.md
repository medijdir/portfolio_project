...
```sh
  ...
  git clone git@github.com:medijdir/portfolio_project.git
...
- GitHub: [Mehdi jdir](https://github.com/medijdir)
- LinkedIn: [Mehdi jdir](https://www.linkedin.com/in/jdir-mehdi-a3055a256/)
...
Feel free to check the [Isuues Pages](https://github.com/medijdir/portfolio_project/issues)
